...
## 说明
### KiCad 简介（[摘自wikipedia](https://en.wikipedia.org/wiki/KiCad)）
KiCad (读作 key-CAD) 是一款跨平台的开源的电子设计自动化(EDA)套件。
...
<LicenseGrid
  licenses={['GPLv3+']}
  links={{ 'GPLv3+': 'https://github.com/KiCad/kicad-source-mirror/blob/master/LICENSE.README' }}
/>
